...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_VENUSAUR] =         {{EVO_MEGA, ITEM_VENUSAURITE, SPECIES_VENUSAUR_MEGA, MEGA_VARIANT_STANDARD}/*,
								  {EVO_HISUIAN, TRUE, SPECIES_IRONTHORNS, 0}*/},
	...
	[SPECIES_CHARIZARD] =        {{EVO_MEGA, ITEM_CHARIZARDITE_X, SPECIES_CHARIZARD_MEGA_X, MEGA_VARIANT_STANDARD},
								  ...
								  {EVO_HISUIAN, TRUE, SPECIES_IRONBUNDLE, 0}*/},
	...
	[SPECIES_BLASTOISE] =        {{EVO_MEGA, ITEM_BLASTOISINITE, SPECIES_BLASTOISE_MEGA, MEGA_VARIANT_STANDARD}/*,
								  {EVO_HISUIAN, TRUE, SPECIES_IRONVALIANT, 0}*/},
	...
	// [SPECIES_CORVIKNIGHT] =      {{EVO_HISUIAN, TRUE, SPECIES_IRONMOTH, 0}},
	...
	// [SPECIES_HATTERENE] =        {{EVO_HISUIAN, TRUE, SPECIES_ROARINGMOON, 0}},
	[SPECIES_IMPIDIMP] =         {{EVO_LEVEL, 27, SPECIES_MORGREM, 0}},
	[SPECIES_MORGREM] =          {{EVO_LEVEL, 36, SPECIES_GRIMMSNARL, 0}},
	// [SPECIES_GRIMMSNARL] =       {{EVO_MEGA, ITEM_GRIMMSNITE, SPECIES_IRONTREADS, MEGA_VARIANT_STANDARD}},
	// [SPECIES_GRIMMSNARL] =       {{EVO_HISUIAN, TRUE, SPECIES_IRONTREADS, 0}},
	...
	// [SPECIES_URSHIFU_SINGLE] =   {{EVO_HISUIAN, TRUE, SPECIES_IRONHANDS, 0}}, 
	// [SPECIES_TOXTRICITY_LOW_KEY] = {{EVO_HISUIAN, TRUE, SPECIES_SLITHERWING, 0}}, 
	// [SPECIES_NYMBLE_S] =    {{EVO_HISUIAN, TRUE, SPECIES_ALCREMIE_GIGA, 0}}, 
	// [SPECIES_URSHIFU_RAPID] =    {{EVO_HISUIAN, TRUE, SPECIES_IRONJUGULIS, 0}}, 
